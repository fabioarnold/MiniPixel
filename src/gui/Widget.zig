...
drawFn: std.meta.FnPtr(fn (*Widget, vg: nvg) void) = drawChildren,

onResizeFn: std.meta.FnPtr(fn (*Widget, *event.ResizeEvent) void) = onResize,
onMouseMoveFn: std.meta.FnPtr(fn (*Widget, *event.MouseEvent) void) = onMouseMove,
onMouseDownFn: std.meta.FnPtr(fn (*Widget, *event.MouseEvent) void) = onMouseDown,
onMouseUpFn: std.meta.FnPtr(fn (*Widget, *event.MouseEvent) void) = onMouseUp,
onMouseWheelFn: std.meta.FnPtr(fn (*Widget, *event.MouseEvent) void) = onMouseWheel,
onTouchPanFn: std.meta.FnPtr(fn (*Widget, *event.TouchEvent) void) = onTouchPan,
onTouchZoomFn: std.meta.FnPtr(fn (*Widget, *event.TouchEvent) void) = onTouchZoom,
onKeyDownFn: std.meta.FnPtr(fn (*Widget, *event.KeyEvent) void) = onKeyDown,
onKeyUpFn: std.meta.FnPtr(fn (*Widget, *event.KeyEvent) void) = onKeyUp,
onTextInputFn: std.meta.FnPtr(fn (*Widget, *event.TextInputEvent) void) = onTextInput,
onFocusFn: std.meta.FnPtr(fn (*Widget, *event.FocusEvent) void) = onFocus,
onBlurFn: std.meta.FnPtr(fn (*Widget, *event.FocusEvent) void) = onBlur,
onEnterFn: std.meta.FnPtr(fn (*Widget) void) = onEnter,
onLeaveFn: std.meta.FnPtr(fn (*Widget) void) = onLeave,
onClipboardUpdateFn: std.meta.FnPtr(fn (*Widget) void) = onClipboardUpdate,
